...
The deadline for ARR commitment is January 6, 2026, which is shortly after the EACL main confernece notification date (January 3, 2026). Papers rejected at the EACL main conference can be committed to the SRW if they meet the SRW submission requirements.
